...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:variable name="codeLang">
        <xsl:choose>
            <!-- SG : correction langues erronées DEGRUYTER EBOOKS-->
            <!-- spa -->
                                        ...
                                        <xsl:when test="//book-part[not(body/book-part)]/book-part-meta/title-group/title">
                                            <xsl:choose>
                                                ...
                                                <xsl:when test="contains($titleToDeduceGenre,'Preliminary')
                                                    ...
                                                    contains($titleToDeduceGenre,'A Einleitung') or 
                                                    ...
                                                    contains($titleToDeduceGenre,'Literatur') or 
                                                    ...
                                                    contains($titleToDeduceGenre,'Einleitung') or 
                                                    ...
                                                    contains($titleToDeduceGenre,'Tabellen') or 
                                                    ...
                                                    contains($titleToDeduceGenre,'Sachregister') or 
                                                    ...
                                                    contains($titleToDeduceGenre,'Schlußwort')">
