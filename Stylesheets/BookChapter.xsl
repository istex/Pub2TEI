...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:variable name="codeLang">
        <xsl:choose>
            ...
            <xsl:when test="$codeLangTitle ='english'">en</xsl:when>
            <xsl:when test="$codeLangTitle ='french'">fr</xsl:when>
            <xsl:when test="$codeLangTitle ='german'">de</xsl:when>
            <xsl:when test="$codeLangTitle ='italian'">it</xsl:when>
            <xsl:when test="$codeLangTitle ='spanish'">es</xsl:when>
                            ...
                            <xsl:otherwise>
                                <profileDesc>
                                    <langUsage>
                                        <xsl:choose>
                                            <!-- grec -->
                                            <xsl:when test="$doi='10.1515/9783110953855.1' or $doi='10.1515/9783110973570.208' or $doi='10.1515/9783110975406.167' or $doi='10.1515/9783110957143.345' or $doi='10.1515/9783110958829.57' or $doi='10.1515/9783110975376.295' or $doi='10.1515/9783110957914.855' or $doi='10.1515/9783110959604.257' or $doi='10.1515/9783110951066.327' or $doi='10.1515/9783110967760-011' or $doi='10.1515/9783110948851.360' or $doi='10.1515/9783110967760-006' or $doi='10.1515/9783110977059.105' or $doi='10.1515/9783110967722.73' or $doi='10.1515/9783110955613.185' or $doi='10.1515/9783110966510.124'">
                                                <language>
                                                    <xsl:attribute name="ident">el</xsl:attribute>
                                                </language>
                                            </xsl:when>
                                            <xsl:when test="$codeLang">
                                                <language>
