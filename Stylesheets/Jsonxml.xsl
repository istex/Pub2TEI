   ...
   <xsl:variable name="genreJson">
    ...
    <xsl:variable name="codeGenreJson">
        <xsl:choose>
            ...
            <xsl:when test="$genreJson='journal'">article</xsl:when>
                    ...
                    <titleStmt>
                        ...
                        <xsl:choose>
                            <xsl:when test="//doc/title ='[NO TITLE AVAILABLE]'">
                                <xsl:copy-of select="$grobid//tei:TEI/tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:title"/>
                            </xsl:when>
                        ...
                        <biblStruct type="article">
                            <analytic>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:apply-templates select="$grobid//tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:biblStruct/tei:analytic"/>
                                    </xsl:otherwise>
                                </xsl:choose>
