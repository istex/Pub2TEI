...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="identifyOrgLevel">
        ...
        <xsl:choose>
            <xsl:when test="not(contains($theOrg,' ')) or contains($theOrg,'/') or contains($theOrg,'College of') or contains($theOrg,'Universidad') or contains($theOrg,'Hospi') or contains($theOrg,'Osservatorio') or contains($theOrg,'Museum') or contains($theOrg,'Center') or contains($theOrg,'Institute') or contains($theOrg,'Institut') or contains($theOrg,'Campus') or contains($theOrg,'Centre') or contains($theOrg,' Universit') or contains($theOrg,'University of') or contains($theOrg,'Academy') or contains($theOrg,'Pasteur') or starts-with($theOrg,'Inserm')  or starts-with($theOrg,'Ministr')">
