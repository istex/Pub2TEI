...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ce="http://www.elsevier.com/xml/common/dtd"
    ...
    <xsl:template match="foreName | fname |rsc:fname |first_name | FirstName | ce:given-name | per_aut/fn | given-names | given_name | corresponding-author-firstname | fname | fnm | wiley:givenNames|given">
        <xsl:if test=". !=''">
            <forename type="first">
